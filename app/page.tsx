...
export default function Home() {
    return (
        <main
            className={`${urbanist.className} container mx-auto flex h-screen max-w-4xl flex-col bg-zinc-100 md:flex-row md:overflow-hidden md:overscroll-contain`}
        >
            <section
                aria-label="Personal Info"
                className="flex flex-none flex-col gap-1 bg-blue-600 text-zinc-100 md:w-72 md:overflow-y-auto"
            >
            ...
            >
                <h1 className="text-xl leading-8">
                    ...
                    specializing in creating dynamic UI / UX systems using OOP,
                ...
                <ul className="list-disc pt-2 pl-5">
                    <li>
                        ...
                        Typescript, CSS in JS, REST, and Graphql.
                    </li>
                    <li>
                    ...
                    <li>
                        Coordinated and collaborated with cross-functional teams
                        to design and refine features.
                    </li>
                    <li>
                        Created unit tests in Jest; system and functional tests
                        in Cypress with mock data in Node.js.
                    </li>
                    <li>
                        Performed functional improvements, debugging, and bug
                        fixes for new and legacy products.
                    </li>
                </ul>
                ...
                <ul className="list-disc pt-2 pl-5">
                    ...
                    <li>
                        Implemented features from design docs, collaborated with
                        various departments for requirements gathering and
                        refining, and unit testing with Jest.
                    </li>
                    <li>
                        Designed and developed UI/UX experience using Bootstrap
                    </li>
                    <li>Debugged and enhanced legacy tools.</li>
                    <li>
                        Implemented testing standard and integrated with CI/CD.
                    </li>
                </ul>
                ...
                <ul className="list-disc pt-2 pl-5">
                    <li>
                        ...
                        in-house and outsourced projects as Lead Engineer on
                        GoQuest, a project-based learning product, and Husky, a
                        bespoke javascript multi-media player.
                    </li>
                    <li>
                        Evaluated, documented, planned, and facilitated sweeping
                        conversion projects to convert legacy Flash content into
                        modern HTML5 format.
                    </li>
                    <li>
                    ...
                    <li>
                        Facilitated technical solutions to bring legacy Flash
                        content to mobile devices using Unity and ScaleForm.
                    </li>
                </ul>
                ...
                <ul className="list-disc py-2 pl-5">
                    <li>
                        Created patented UI / UX designs and functionality for
                        social systems.
                    </li>
                    <li>
                    ...
                    <li>
                        Involved in various levels of project development, from
                        prototyping and system design to game launches and live
                        game support.
                    </li>
                    <li>
                        Reduced development time on time-sensitive game rebuilds
                        by developing an in-code font system that would prevent
                        the Art department from having to rebuild most assets.
                    </li>
                    <li>
                        Created documentation for various projects, systems, and
                        proposals.
                    </li>
                    <li>
                        Lead developer on Mini-game system design for an
                        unannounced mobile game in Cocos2dx and Cocosbuilder.
                    </li>
                </ul>
            </section>
        </main>
